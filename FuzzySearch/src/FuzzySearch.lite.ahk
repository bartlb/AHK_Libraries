/**
 * FuzzySearch.lite is a lightweight function that uses basic 'fuzzy matching' logic to 
 * find all possible matches to a query within any custom, string-based dictionary. The 
 * results of this search method are NOT weighted, and matches are returned in an array 
 * of no significant order.
 *
